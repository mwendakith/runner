...
class CreateVlPartnerRejections extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('vl_partner_rejections', function (Blueprint $table) {
            $table->increments('ID');
    ...
    {
        //
        Schema::dropIfExists('vl_partner_rejections');
    }
}
